...
\vspace{-1mm}
\begin{ex}[Écrire en fonction de]
...
\begin{tikzpicture}[x=0.8cm,y=0.8cm,line cap=round]
  \draw[very thick] (0,0) -- (3,0) node[midway,above] {$x$} -- (5,0) node[midway,above] {$2$};
  \node[left] at (0,0) {$A$};
  \node[right] at (5,0) {$B$};
  \draw[very thick] (0,-1) -- (2,-1) node[midway,above] {$3$} -- (5,-1) node[midway,above] {$x$} -- (7,-1) node[midway,above] {$x$};
  \node[left] at (0,-1) {$C$};
  \node[right] at (7,-1) {$D$};
  \draw[very thick] (0,-2) -- (4,-2) node[midway,above] {$2x$} -- (5.5,-2) node[midway,above] {$1$};
  \node[left] at (0,-2) {$E$};
  \node[right] at (5.5,-2) {$F$};
\end{tikzpicture}
\end{center}
\end{ex}
...
\vspace{-1mm}
\begin{ex}[Avec un autre programme]
