...
\begin{defn}
Dans un tableau de nombres à deux lignes, on reconnaît une situation de proportionnalité lorsque les nombres de la deuxième ligne s'obtiennent en multipliant ceux de la première par un même nombre.
\medskip
