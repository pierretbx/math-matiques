...
\section{Vocabulaire (Rappels)}

\subsection{Fractions et quotient}
...
\begin{scriptsize}
.5\draw[color=black] (7.2,3.4554545454545424) node {\Large{$a \div b = \dfrac{a}{b}$}};
...
\draw[color=black] (11.28,1.4154545454545453) node {\Large{Dénoiminateur}};
\end{scriptsize}
\end{tikzpicture}
\end{center}

\subsection{Fractions et produit}

\begin{dft}
La fraction $\dfrac{\textcolor{red}{a}}{\textcolor{blue}{b}}$ est la solution de l'opération à trou : $\textcolor{blue}{b} \times \cdot = \textcolor{red}{a}$
\end{dft}
...
\begin{ex}
\begin{enumerate}
\item[•] Le quotient de $3,5$ par $2$ est le résultat de la division de $3,5$ par $2$. On le note $3,5 \div 2 = \dfrac{3,5}{2}= 1,75$.
...
\subsection{Fractions et proportion}
...
\draw [shift={(5.18,4.02)},line width=1.2pt,color=black,fill=blue,fill opacity=0.1]  (0,0) --  plot[domain=1.241539285032363:2.4965180680191064,variable=\t]({1.*1.8160113582383595*cos(\t r)+0.*1.8160113582383595*sin(\t r)},{0.*1.8160113582383595*cos(\t r)+1.*1.8160113582383595*sin(\t r)}) -- cycle ;
\draw [shift={(5.18,4.02)},line width=1.2pt,color=black,fill=blue,fill opacity=0.1]  (0,0) --  plot[domain=2.4965180680191064:3.7478303177768257,variable=\t]({1.*1.8252497086746013*cos(\t r)+0.*1.8252497086746013*sin(\t r)},{0.*1.8252497086746013*cos(\t r)+1.*1.8252497086746013*sin(\t r)}) -- cycle ;
\draw [shift={(5.18,4.02)},line width=1.2pt,color=black,fill=blue,fill opacity=0.1]  (0,0) --  plot[domain=3.7478303177768257:5.002790922933131,variable=\t]({1.*1.8252671037412573*cos(\t r)+0.*1.8252671037412573*sin(\t r)},{0.*1.8252671037412573*cos(\t r)+1.*1.8252671037412573*sin(\t r)}) -- cycle ;
\draw [shift={(5.18,4.02)},line width=1.2pt,color=black,fill=blue,fill opacity=0.1]  (0,0) --  plot[domain=5.002790922933131:6.272196738496853,variable=\t]({1.*1.8160396471443017*cos(\t r)+0.*1.8160396471443017*sin(\t r)},{0.*1.8160396471443017*cos(\t r)+1.*1.8160396471443017*sin(\t r)}) -- cycle ;
\draw [shift={(5.18,4.02)},line width=1.2pt,color=black,fill=blue,fill opacity=0.1]  (0,0) --  plot[domain=-0.010988568682733124:1.241539285032363,variable=\t]({1.*1.8201098867925534*cos(\t r)+0.*1.8201098867925534*sin(\t r)},{0.*1.8201098867925534*cos(\t r)+1.*1.8201098867925534*sin(\t r)}) -- cycle ;
...
\begin{ex}
$2 \times 9 = 18$ signifie :
\begin{enumerate}
\item[•]$2$ et $9$ sont des diviseurs de $18$.
\item[•]$18$ est divisible par $2$ et par $9$.
\item[•]$18$ est un multiple de $2$ et de $9$.
\end{enumerate}
\end{ex}
...
\noindent avec $ \quad reste  \quad < \quad quotient$
\end{regle}
