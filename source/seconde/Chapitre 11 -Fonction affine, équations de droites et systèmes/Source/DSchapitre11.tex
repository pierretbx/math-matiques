...
1) Soit $\Delta$ une droite passant par deux points, $A=(1,2)$ et $B=(0,1)$. Déterminer un vecteur directeur de $\Delta$ et en déduire une équation cartésienne de la droite $\Delta$. \\
...
\end{array} \right). \\
$
Déterminer  une équation cartésienne de la droite $\Delta_1$.
...
5) Soit un point $C=(1000,1001)$, dire si $A,B$ et $C$ sont alignés ou non. (On rappel que $A$,$B$ et $C$ sont alignés si $C \in \Delta$) \\
...
7) On suppose que les droites $\Delta_3$ et $\Delta_4$ sont sécantes. On cherche le point d'intersection $I$ de ces deux droites. Pour cela résoudre le système suivant et interpréter le résultat: \\
