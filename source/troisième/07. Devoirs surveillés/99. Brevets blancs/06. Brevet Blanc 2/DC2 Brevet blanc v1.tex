...
\newpage
\pagestyle{empty}
Troisième Générale \hfill Session Avril 2022
...
\newpage
\paragraph{Exercice 1}: \hfill \textbf{14 points}
\medskip
...
\paragraph{Exercice 3}: \hfill \textbf{15 points}
\medskip
...
\paragraph{Exercice 6}: \hfill \textbf{9 points}
\medskip
...
\begin{center}
\includegraphics[scale=0.43]{../40.Image/DC2 1.png}
\end{center}
\end{doc}
\end{minipage}
\hspace{0.5cm}
...
\begin{center}
\includegraphics[scale=0.3]{../40.Image/DC2 2.png}
\end{center}
\end{doc}
...
\paragraph{Exercice 8}: \hfill \textbf{8 points}
\medskip

\noindent \begin{minipage}{10cm}
Gabrielle a crée quatre variables \textbf{x}, \textbf{Étape 1}, \textbf{Étape 2} et \textbf{Résultat}, puis elle a saisi le script ci-contre (en couleur sur l'\textbf{ANNEXE}) en langage Scratch.
\medskip
